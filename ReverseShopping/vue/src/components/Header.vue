        ...
        <b-navbar-nav class="ml-auto">
          <template v-if="$store.state.isLoggedIn">
            <div id="user-link-wrapper" class="mr-4">
                ようこそ<b-link id="user-link" to="/user">hoge</b-link>さん
            </div>   
            <b-button
              v-b-modal.modal-1
              size="sm"
          ...
          <template v-else>
            <b-button  to="/sign-in" size="sm" class="button my-2 mr-2 my-sm-0">ログイン</b-button>
            <b-button to="/sign-up" size="sm" class="button my-2 my-sm-0">新規登録</b-button>
          </template>
        </b-navbar-nav>
    </b-navbar>
    <b-modal
